...
/**
 * Servlet implementation class addCGiftServlet
 */
@WebServlet("/addCGiftServlet")
public class addCGiftServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public addCGiftServlet() {
        super();
...
DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
		...
		crecipienthelp.insertRecipient(cr);
