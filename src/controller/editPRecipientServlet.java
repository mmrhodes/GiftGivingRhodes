...
/**
 * Servlet implementation class editPRecipientServlet
 */
@WebServlet("/editPRecipientServlet")
public class editPRecipientServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public editPRecipientServlet() {
        super();
